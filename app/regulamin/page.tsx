      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl shadow-blue-100/60 dark:shadow-none border border-gray-100/80 dark:border-gray-800 p-8">
          ...
          <div className="prose prose-sm text-gray-600 dark:text-gray-400 space-y-10">
            ...
            {/* §4 – Nowy zapis o cenach */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§4. Ceny i indywidualna wycena</h2>
              <p>Ceny prezentowane w Serwisie mają charakter orientacyjny, chyba że przy danej usłudze wyraźnie wskazano inaczej.</p>
              <p className="mt-3">Ostateczna cena usługi może zależeć w szczególności od zakresu prac, stopnia skomplikowania zlecenia, czasu potrzebnego na realizację, wykorzystanych technologii oraz dodatkowych wymagań zgłoszonych przez Klienta.</p>
              <p className="mt-3">Jeżeli zakres zlecenia nie pozwala na jednoznaczne ustalenie ceny na podstawie cennika, Realizator Usługi przedstawia Klientowi indywidualną wycenę <strong>przed rozpoczęciem realizacji usługi</strong>.</p>
              <p className="mt-3">Rozpoczęcie realizacji usługi wymagającej indywidualnej wyceny następuje po przedstawieniu Klientowi ceny lub sposobu jej obliczenia oraz po akceptacji przez Klienta przedstawionych warunków.</p>
              <p className="mt-3">Zmiana zakresu prac po rozpoczęciu realizacji może skutkować zmianą ceny. W takim przypadku Realizator Usługi przedstawia Klientowi informację o dodatkowej wycenie przed wykonaniem dodatkowych prac.</p>
              <p className="mt-3">Ceny podawane w Serwisie są cenami brutto, o ile przy danej usłudze wyraźnie nie wskazano inaczej.</p>
              <p className="mt-3">W przypadku usług rozliczanych godzinowo cena naliczana jest zgodnie z aktualnie obowiązującą stawką wskazaną w Serwisie lub indywidualnie zaakceptowaną przez Klienta przed rozpoczęciem realizacji.</p>
              <p className="mt-3">Aktualizacja cennika obowiązuje dla zgłoszeń złożonych po opublikowaniu nowej wersji cennika, z zastrzeżeniem wcześniej potwierdzonych indywidualnych wycen i uzgodnionych warunków realizacji.</p>
              <p className="mt-3">Minimalna wartość jednorazowego zlecenia wynosi <strong>100 zł</strong>.</p>
              <p className="mt-3">Realizacja w trybie pilnym może wiązać się z dopłatą do <strong>50% wartości usługi</strong>.</p>
              <p className="mt-3">Podanie konkretnych wymagań technologicznych (np. konkretnej technologii, języka programowania lub frameworku) w polu „Szczegółowy opis problemu" w Formularzu może skutkować uwzględnieniem tych wymagań w wycenie.</p>
            ...
            {/* §5 – Zakres usługi */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§5. Zakres usługi</h2>
              <p>Zakres usługi ustalany jest na podstawie zgłoszenia Klienta oraz dodatkowych ustaleń dokonanych przed rozpoczęciem realizacji.</p>
              <p className="mt-3">Cena podstawowa obejmuje wyłącznie zakres prac wskazany w opisie usługi lub indywidualnej wycenie.</p>
              <p className="mt-3">Funkcje, poprawki, integracje lub inne czynności niewchodzące w pierwotnie ustalony zakres mogą zostać wycenione dodatkowo.</p>
              <p className="mt-3">Realizator Usługi informuje Klienta o konieczności dodatkowej wyceny przed rozpoczęciem prac wykraczających poza wcześniej ustalony zakres.</p>
            </section>

            {/* §6 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§6. Zaliczki i zadatek</h2>
              <p>W przypadku Usług o wartości przekraczającej <strong>250 zł</strong> lub charakteryzujących się wysokim stopniem złożoności (w szczególności konfiguracja dedykowanych serwerów, rozbudowane systemy automatyzacji transmisji, pakiety usług oraz pełny setup live), Realizator Usługi zastrzega sobie prawo do uzależnienia rozpoczęcia prac od wpłaty <strong>zadatku</strong> w wysokości do <strong>50%</strong> szacunkowej wartości Zlecenia.</p>
            ...
            {/* §7 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§7. Kody zniżkowe i program partnerski</h2>
            ...
            {/* §8 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§8. Usługi dodatkowe</h2>
            ...
            {/* §9 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§9. Prawo odstąpienia od umowy, zwroty i reklamacje</h2>
              ...
              <p className="font-bold text-gray-900 dark:text-gray-100 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/60 rounded-xl p-3 mt-3">
                ⚠️ Realizacja Usługi <strong>rozpoczyna się niezwłocznie</strong> po potwierdzeniu zgłoszenia klienta. Z tego względu <strong>rozpoczęta lub w pełni zrealizowana Usługa nie podlega zwrotowi</strong>. Klientowi przysługuje wyłącznie prawo do reklamacji zgodnie z tym paragrafem (§9).
              </p>
            ...
            {/* §10 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§10. Ochrona przed nadużyciami</h2>
            ...
            {/* §11 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§11. Zawarcie umowy</h2>
            ...
            {/* §12 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§12. Postanowienia końcowe</h2>
            ...
            {/* §13 */}
            <section>
                             <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-4">§13. Pozasądowe rozwiązywanie sporów (ODR)</h2>
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 pt-4 mt-6">
              <p className="text-xs text-gray-400 dark:text-gray-600 text-center">Regulamin obowiązuje od dnia 08.03.2026 r. <i>(Aktualizacja wchodzi z dniem 04.09.2026 r.)</i></p>
            </div>
