      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl shadow-blue-100/60 dark:shadow-none border border-gray-100/80 dark:border-gray-800 p-8">
          ...
          <div className="prose prose-sm text-gray-600 dark:text-gray-400 space-y-6">
            ...
            {/* §7 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§7. Usługi dodatkowe</h2>
              ...
              <p className="mt-2">Realizator Usługi zastrzega sobie prawo do odmowy przyjęcia Zgłoszenia z usługą dodatkową (Priorytetowa lub Natychmiastowa realizacja) w przypadku braku dostępności, o czym Klient zostanie poinformowany.</p>
              <p className="mt-1">Kody zniżkowe nie obejmują dopłat za usługi dodatkowe (Priorytetowa i Natychmiastowa realizacja).</p>
            </section>

            {/* §8 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§8. Prawo odstąpienia od umowy, zwroty i reklamacje</h2>
              ...
              <p className="font-bold text-gray-900 dark:text-gray-100 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/60 rounded-xl p-3 mt-2">
                ⚠️ Realizacja Usługi (w tym Usług dodatkowych) <strong>rozpoczyna się niezwłocznie</strong> po potwierdzeniu zgłoszenia klienta. Z tego względu <strong>rozpoczęta lub w pełni zrealizowana Usługa nie podlega zwrotowi</strong>. Klientowi przysługuje wyłącznie prawo do reklamacji zgodnie z niniejszym paragrafem (§8).
              </p>
              <p className="mt-2">Usługi, które zostały w pełni zrealizowane, nie podlegają zwrotowi kosztów — z zastrzeżeniem powyższego przepisu o prawie odstąpienia oraz przypadków wyraźnie przewidzianych przez obowiązujące przepisy prawa.</p>
              <p className="mt-2">Usługi dodatkowe (w tym Priorytetowa i Natychmiastowa realizacja) stanowią świadczenia pomocnicze i po ich rozpoczęciu lub zrealizowaniu nie podlegają zwrotowi, chyba że zostały niewykonane z przyczyn leżących po stronie Realizatora Usługi.</p>
              <p id="reklamacje" className="font-semibold text-gray-700 dark:text-gray-300 mt-3 mb-1 scroll-mt-20">Reklamacje:</p>
            ...
            {/* §9 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§9. Ochrona przed nadużyciami</h2>
            ...
            {/* §10 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§10. Zawarcie umowy</h2>
            ...
            {/* §11 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§11. Postanowienia końcowe</h2>
            ...
            {/* §12 */}
            <section>
              <h2 className="font-bold text-gray-800 dark:text-gray-100 text-base mb-3">§12. Pozasądowe rozwiązywanie sporów (ODR)</h2>
